...
import com.ssc.engquiz.activities.engsets;
import com.ssc.engquiz.game.QuizActivity;
import com.ssc.engquiz.game.ResultAcitvity;

public class ResultAcitvity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        setContentView(R.layout.activity_result_acitvity2);

        toolbar = findViewById(R.id.set_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle("Result of Set");
